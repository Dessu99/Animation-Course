...
public class Leg_Step : MonoBehaviour
{
    
    [SerializeField] Transform homeTransform;   // The position and rotation we want to stay in range of
    [SerializeField] float wantStepAtDistance;  // Stay within this distance of home
    [SerializeField] float moveDuration;         // How long a step takes to complete
    [SerializeField] float stepOvershootFraction;  // Fraction of the max distance from home we want to overshoot by    
